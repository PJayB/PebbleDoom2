...
#define load_pack_placement(pack, heap, resource_id) _load_pack_placement(#pack, pack, resource_id, (heap)->ptr, (heap)->size)
#define load_pack_placement_offset(pack, heap, offset, resource_id) _load_pack_placement(#pack, pack, resource_id, ((uint8_t*)(heap)->ptr) + (offset), (heap)->size - (offset))
